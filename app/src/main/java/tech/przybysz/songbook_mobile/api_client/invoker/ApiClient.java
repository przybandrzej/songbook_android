package tech.przybysz.songbook_mobile.api_client.invoker;
...
import tech.przybysz.songbook_mobile.api_client.invoker.auth.ApiKeyAuth;
import tech.przybysz.songbook_mobile.api_client.invoker.auth.HttpBasicAuth;
import tech.przybysz.songbook_mobile.api_client.invoker.auth.OAuth;
import tech.przybysz.songbook_mobile.api_client.invoker.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
    ...
    private JSON json;
    private String baseUrl = "https://stk-uep.pl";
    ...
    public ApiClient setBaseUrl(String url) {
        this.baseUrl = url;
        this.adapterBuilder.baseUrl(url);
        return this;
    }

    public ApiClient setLoggingLevel(HttpLoggingInterceptor.Level loggingLevel) {
        okBuilder.interceptors().removeIf(it -> it instanceof HttpLoggingInterceptor);
    ...
    public ApiClient setLocalDateFormat(DateTimeFormatter dateFormat) {
        this.json.setLocalDateTimeFormat(dateFormat);
        return this;
    }
